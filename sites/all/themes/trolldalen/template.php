 ...
 */
function trolldalen_breadcrumb($variables) {
 ...
 */
function trolldalen_preprocess_maintenance_page(&$variables) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // trolldalen_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  trolldalen_preprocess_html($variables);
}

/**
 * Override or insert variables into the html template.
 */
function trolldalen_preprocess_html(&$variables) {
  // Toggle fixed or fluid width.
  if (theme_get_setting('trolldalen_width') == 'fluid') {
 ...
 * Override or insert variables into the html template.
 */
function trolldalen_process_html(&$variables) {
 ...
 */
function trolldalen_preprocess_page(&$variables) {
 ...
 */
function trolldalen_preprocess_node(&$variables) {
 ...
 */
function trolldalen_preprocess_comment(&$variables) {
 ...
 */
function trolldalen_preprocess_block(&$variables) {
 ...
 * Override or insert variables into the page template.
 */
function trolldalen_process_page(&$variables) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function trolldalen_preprocess_region(&$variables) {
